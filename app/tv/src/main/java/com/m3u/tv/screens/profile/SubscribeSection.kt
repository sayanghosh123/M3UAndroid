...
fun SettingViewModel.SubscribeSection() {
    ...
    LazyColumn(
        ...
        item {
            ...
            val tabIndex =
                remember(properties.selectedState.value) {
                    dataSources.indexOf(properties.selectedState.value)
                }
...
private fun SettingViewModel.xtreamPageConfiguration(
    ...
    with(scope) {
        ...
        input(
            ...
            onValueChanged = { properties.basicUrlState.value = it },
            placeholder = R.string.feat_setting_placeholder_basic_url
        )
        input(
